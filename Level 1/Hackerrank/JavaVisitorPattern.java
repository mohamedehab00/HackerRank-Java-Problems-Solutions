...
//reference solution for DFS: https://programs.programmingoneonone.com/2021/02/hackerrank-java-visitor-pattern-solution.html
...
class FancyVisitor extends TreeVis {
    ...
    public int getResult() {
        // implement this
        return Math.abs(this.resultNodes - this.resultLeafs);
    }

    public void visitNode(TreeNode node) {
        // implement this
        if (node.getDepth() % 2 == 0) {
            this.resultNodes += node.getValue();
        }
    }
    ...
    public void visitLeaf(TreeLeaf leaf) {
        ...
        if (leaf.getColor() == Color.GREEN) {
            this.resultLeafs += leaf.getValue();
        }
    }
}
